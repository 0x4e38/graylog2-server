...
public class DocumentationBrowserResource extends RestResource {
    ...
    @Inject
    public DocumentationBrowserResource(MimetypesFileTypeMap mimeTypes, HttpConfiguration httpConfiguration) {
        this.mimeTypes = requireNonNull(mimeTypes);
        this.httpConfiguration = requireNonNull(httpConfiguration);
    }
